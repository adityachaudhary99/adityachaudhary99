...
HTTP, cloud, git, media, torrents - a single static Go binary with a native parallel engine (resume + checksums) that auto-dispatches to the right backend (rclone / git / yt-dlp / aria2c / curl). Latest: **v0.7.0** - accessible output, post-download hooks, multi-source.
**Go · Cobra · goreleaser**
...
### [Data File Viewer](https://github.com/adityachaudhary99/data-file-viewer) - binary data explorer for VS Code / Cursor (v2)
